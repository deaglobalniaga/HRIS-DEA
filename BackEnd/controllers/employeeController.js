...
const formatEmployee = (emp) => {
    ...
    const formatted = {
        ...
        email: emp.email || (emp.users?.email && !emp.users.email.endsWith('@deaglobalniaga.com') ? emp.users.email : '') || '',
        email_office: detail.email_office || (emp.users?.email && emp.users.email.endsWith('@deaglobalniaga.com') ? emp.users.email : '') || '',
