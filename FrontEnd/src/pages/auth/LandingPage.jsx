...
<Link to="/login" className="w-full sm:w-auto h-12 px-8 bg-primary text-on-primary rounded-xl font-label-md text-label-md hover:bg-primary-container transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 group">
            Mulai Sekarang
            <span className="material-symbols-outlined text-[18px] group-hover:translate-x-1 transition-transform">arrow_forward</span>
</Link>
<Link to="/login" className="w-full sm:w-auto h-12 px-8 bg-surface-container text-on-surface rounded-xl font-label-md text-label-md hover:bg-surface-container-high transition-all flex items-center justify-center gap-2">
...
<Link to="/login" className="font-label-md text-label-md text-primary inline-flex items-center gap-1 hover:text-primary-container w-fit">
